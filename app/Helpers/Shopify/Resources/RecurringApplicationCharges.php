...
class RecurringApplicationCharges extends Base
{
    ...
    {
        return $this->baseDelete("/admin/recurring_application_charges/$id.json");
    }

    public function single($id)
    {
        return $this->get("/admin/recurring_application_charges/$id.json")['recurring_application_charge'];
    }
}